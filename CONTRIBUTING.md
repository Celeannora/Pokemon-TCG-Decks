...
5. Run `python scripts/validate_deck.py Decks/<folder>/decklist.txt` and confirm validation passes before opening a PR

Use `.github/DECK_TEMPLATE/` as a starting point for all three files.
...
- Validate any new or modified decklists with `python scripts/validate_deck.py`
